...

{
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderID,CustomerID,CustomerName,OrderTime,PickupTime")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderID,CustomerID,CustomerName,OrderTime,PickupTime")] Order order)
        {
            if (id != order.OrderID)
            {
                return NotFound();
